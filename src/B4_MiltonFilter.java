public class B4_MiltonFilter extends World {
   ...
   public void go() {
      ...
      for (int row = 520; row < 680; row++)    //*** this is using new getBackground
      {
         for (int col = 70; col < 410; col++)    //*** this is using new getBackgroun
         {
...
//shoes
            ...
            {
//               plane.setPixelColor(255, 100, 200);
            }

            if ((red > 0 && green > 10 && blue > 20) && (red < 255 && green < 200 && blue < 200)) {
               plane.setPixelColor(100, 10, 225); //body
            }
            if ((red > 200 && green > 100 && blue > 20) && (red < 254 && green < 160 && blue < 240)) {
               plane.setPixelColor(255, 0, 0); //yellow letters on car
            }
            if ((red > 200 && green > 190 && blue > 0) && (red < 255 && green < 255 && blue < 30)) {
               plane.setPixelColor(123, 0, 251);
            }
         }
      }
      //shorts
      for (int row = 350; row < 500; row++)    //*** this is using new getBackground
      {
         for (int col = 220; col < 340; col++)    //*** this is using new getBackgroun
         {
            plane.teleport(col, row);
...
//            if (red > 85 && green > 100 && blue > 180) //&&green<240 && blue< 100)
            {
//               plane.setPixelColor(100, 200, 200);
            }

            if ((red >= 200 && green >= 230 && blue >= 225) && (red <= 255 && green <= 255 && blue <= 255)) {
               plane.setPixelColor(0, 210, 10);
//            }
//            if ((red > 200 && green > 0 && blue > 0) && (red < 254 && green < 160 && blue < 100)) {
//               plane.setPixelColor(255, 0, 0); //yellow letters on car
//            }
//            if ((red > 0 && green > 0 && blue > 0) && (red < 255 && green < 100 && blue < 100)) {
